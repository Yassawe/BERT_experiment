...
torchrun --nnodes=1 --nproc_per_node 4 bert.py > reports/x1
...
torchrun --nnodes=1 --nproc_per_node 4 bert.py > reports/r25

export LD_LIBRARY_PATH=/src/main/modified_nccl/random/50/build/lib/
torchrun --nnodes=1 --nproc_per_node 4 bert.py > reports/r50

export LD_LIBRARY_PATH=/src/main/modified_nccl/random/75/build/lib/
torchrun --nnodes=1 --nproc_per_node 4 bert.py > reports/r75

export LD_LIBRARY_PATH=/src/main/modified_nccl/random/90/build/lib/
torchrun --nnodes=1 --nproc_per_node 4 bert.py > reports/r90
...
# export LD_LIBRARY_PATH=/usr/lib/x86_64-linux-gnu/
# nvprof --devices 0 --concurrent-kernels on --profile-child-processes --trace gpu --print-gpu-trace --openacc-profiling off --normalized-time-unit ms --profile-from-start off --csv --log-file ./csv/BERT%p.csv CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node 4
